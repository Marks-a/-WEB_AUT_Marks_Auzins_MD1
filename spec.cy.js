...
context.skip("Button Clicking scenarion", () => {
  beforeEach(() => {
    cy.visit("/buttons");
  })
  it("Click on radio button", () => {
...
context("MD1", () => {
  ...
  it("Click on grid option", () => {
    gridPage.clickOnGrid.click();
   //Clicking on items
  gridPage.buttonList.contains("Two").click();
  gridPage.buttonList.contains("Four").click();
  gridPage.buttonList.contains("Six").click();
  gridPage.buttonList.contains("Eight").click();
   //Confirms that there are active
  gridPage.activeButton.contains("Two");
  gridPage.activeButton.contains("Four");
  gridPage.activeButton.contains("Six");
  gridPage.activeButton.contains("Eight");
   //Confirm that others are not active
   gridPage.notActiveButton.contains("One");
   gridPage.notActiveButton.contains("Three");
   gridPage.notActiveButton.contains("Five");
   gridPage.notActiveButton.contains("Seven");
   gridPage.notActiveButton.contains("Nine");
